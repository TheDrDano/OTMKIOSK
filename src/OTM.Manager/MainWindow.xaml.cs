...
public partial class MainWindow : Window
{
    ...
    private static string DescribeConnectionFailure(ManagedStation station, Exception exception)
    {
        ...
        {
            return $"Timed out connecting to {station.Url}. Check that the station is powered on, SimpleKioskOS 8.1.2 or newer is installed, OTMKioskService is running, and Windows Firewall allows TCP 47821 on the station network profile.";
        }
